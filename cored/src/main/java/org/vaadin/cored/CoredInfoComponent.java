...
public class CoredInfoComponent extends CustomComponent {
	...
	public CoredInfoComponent() {
		super();
		root.addComponent(new Label("111Cored is an experimental real-time collaborative editor for creating <a href=\"http://vaadin.com\">Vaadin</a> web applications.", Label.CONTENT_XHTML));
